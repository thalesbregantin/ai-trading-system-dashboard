...
FIREBASE_CONFIG = {
    ...
    "project_id": "ai-trading-system-fb057",
...
# Carregar configuração real do arquivo JSON ou variável de ambiente
try:
    # Primeiro tenta carregar da variável de ambiente (Railway)
    ...
    if firebase_env:
        ...
        print("✅ Firebase configurado via arquivo local")
except Exception as e:
    print(f"❌ Erro ao carregar configuração Firebase: {e}")
    print("⚠️  Firebase não configurado - algumas funcionalidades podem não funcionar")
