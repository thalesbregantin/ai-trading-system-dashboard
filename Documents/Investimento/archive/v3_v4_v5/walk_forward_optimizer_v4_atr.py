...
"""
Walk-Forward Optimization System v4.0 - RISCO DINÂMICO COM ATR
===============================================================
Versão de elite que usa o genetic_optimizer_v4_atr para risco adaptativo.
...
import pandas as pd
import numpy as np
from genetic_optimizer_v4_atr import GeneticTradingOptimizer
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('logs/walk_forward_v4_atr.log', encoding='utf-8'),
        logging.StreamHandler()
    ]
)
logger = logging.getLogger(__name__)

class WalkForwardOptimizerV4:
    """
    Sistema de Walk-Forward Optimization v4.0 - RISCO DINÂMICO COM ATR
    """
    ...
    def __init__(self):
        ...
        # Instanciar o motor de simulação e otimização v4.0
        self.optimizer_engine = GeneticTradingOptimizer()
        
        logger.info("🚀 WALK-FORWARD OPTIMIZER v4.0 - RISCO DINÂMICO COM ATR")
        ...
        logger.info("🔄 Sistema de risco adaptativo: ATR-based Stop Loss/Take Profit")

    def load_all_data(self):
        """Carrega todos os dados para os pares de trading."""
        logger.info("📥 Carregando dados para Walk-Forward v4.0...")
        full_data = {}
    ...
    def run_optimization_on_window(self, training_data):
        ...
        logger.info(f"🧬 Otimizando na janela de treino (v4.0 - ATR)...")
        try:
    ...
    def run_backtest_on_window(self, testing_data, best_params):
        ...
        logger.info(f"📊 Testando na janela out-of-sample (v4.0 - ATR)...")
        try:
            all_results = []
            total_profit = 0
            total_trades = 0
    ...
    def process_windows(self, windows):
        ...
        logger.info("🔄 Processando janelas de Walk-Forward v4.0...")
    ...
    def analyze_final_results(self, out_of_sample_results):
        ...
        logger.info("📊 Analisando resultados finais v4.0...")
        ...
        report_file = self.results_dir / "walk_forward_results_v4_atr.json"
        with open(report_file, 'w') as f:
            json.dump(final_report, f, indent=4, default=str)
            
        # Log dos resultados
        logger.info("🏆 RESULTADOS WALK-FORWARD v4.0 - RISCO DINÂMICO COM ATR:")
    ...
    def run(self):
        ...
        logger.info("🚀 INICIANDO WALK-FORWARD OPTIMIZATION v4.0 - RISCO DINÂMICO COM ATR")
        logger.info("=" * 70)
        logger.info("🎯 NOVA FUNCIONALIDADE: Stop Loss/Take Profit baseado em volatilidade")
        logger.info("📊 ATR: Average True Range para risco adaptativo")
        logger.info("🔄 Sistema se adapta automaticamente à volatilidade do mercado")
        ...
        logger.info("🎉 WALK-FORWARD OPTIMIZATION v4.0 CONCLUÍDO!")
        
        return final_report

def main():
    """Função principal."""
    optimizer = WalkForwardOptimizerV4()
    results = optimizer.run()
    
    if results:
        print("\n🎯 RESUMO FINAL v4.0 - RISCO DINÂMICO COM ATR:")
        ...
        print(f"🔄 Sistema: Risco adaptativo baseado em ATR")
    else:
        print("❌ Falha na execução do Walk-Forward Optimization v4.0")
